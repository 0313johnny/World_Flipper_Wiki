...
function start(){
    document.addEventListener("mousedown", show_info, false);
}
        ...
        if(e.buttons== 1){
            ...
            for( var i = 0 ; i < DataBase.length ; i++ ) {
                if( DataBase[i][1].v == clicked_block.id.substr(5) )
                {
                    ...
                    document.getElementById("info_name").innerHTML= "名稱：" + DataBase[i][3].v;
                    document.getElementById("info_contribute").innerHTML= "介紹：" + DataBase[i][4].v;
                    break;
                }
